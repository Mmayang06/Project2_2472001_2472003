...
<body
    class="bg-[#f9f5ed] text-[#030706] font-sans antialiased min-h-screen flex flex-col md:flex-row overflow-x-hidden">

    <!-- Sidebar -->
    <aside
        class="w-full md:w-80 bg-[#20394a] text-[#f9f5ed] flex flex-col flex-shrink-0 border-r border-[#6196aa]/20 min-h-screen md:h-screen md:sticky md:top-0 md:overflow-y-auto">
        <!-- Brand Logo & App Name -->
        <div class="p-6 border-b border-[#6196aa]/20 flex items-center justify-between">
            <a href="/staf-lab/home" class="flex items-center gap-3 group">
                <div
                    class="p-2 bg-[#6196aa] rounded-xl text-[#f9f5ed] shadow-md group-hover:scale-105 transition-transform duration-200">
                ...
                <div>
                    ...
                    <span
                        class="text-[10px] text-emerald-400 font-semibold tracking-wide block mt-1">{{ session('user')['username'] ?? 'Staf Lab' }}</span>
                </div>
            </a>
            <a href="/profile" title="Edit Profil"
                class="p-2 bg-[#6196aa]/10 text-[#6196aa] hover:bg-[#6196aa] hover:text-[#f9f5ed] rounded-lg transition-colors shadow-sm ml-2 shrink-0">
        ...
        <nav class="flex-grow p-4 space-y-2 mt-4">
            <a href="{{ url('/staf-lab/home') }}"
                class="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-medium text-sm transition-all duration-200 text-[#c9ccc3] hover:bg-[#6196aa]/10 hover:text-white cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ url('/staf-lab/daftar-inventaris') }}"
                class="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-medium text-sm transition-all duration-200 bg-[#6196aa] text-white shadow-lg cursor-pointer">
                <svg viewBox="0 0 24 24" class="h-5 w-5" fill="currentColor">
                    <path
                        d="M20 3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 14H5v-2h6v2zm0-4H5v-2h6v2zm8-4H5V7h14v2z" />
                </svg>
                Daftar Inventaris
            </a>
            <a href="{{ url('/staf-lab/bhp') }}"
                class="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-medium text-sm transition-all duration-200 text-[#c9ccc3] hover:bg-[#6196aa]/10 hover:text-white cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ url('/staf-lab/bhp/riwayat') }}"
                class="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-medium text-sm transition-all duration-200 text-[#c9ccc3] hover:bg-[#6196aa]/10 hover:text-white cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ url('/staf-lab/maintenance') }}"
                class="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-medium text-sm transition-all duration-200 text-[#c9ccc3] hover:bg-[#6196aa]/10 hover:text-white cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ url('/staf-lab/perlu-diganti') }}" class="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-medium text-sm transition-all duration-200 text-[#c9ccc3] hover:bg-[#6196aa]/10 hover:text-white cursor-pointer">
        ...
        <div class="p-4 border-t border-[#6196aa]/20">
            ...
            <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                class="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg border border-[#c9ccc3]/20 hover:bg-[#c9ccc3]/10 text-xs font-semibold text-[#c9ccc3] hover:text-[#f9f5ed] transition-all duration-200 cursor-pointer">
    ...
    <main class="flex-grow flex flex-col min-w-0">
        <!-- Top Navbar -->
        <header
            class="bg-[#f9f5ed]/80 backdrop-blur-md border-b border-[#c9ccc3]/40 h-20 px-6 md:px-8 flex items-center justify-between sticky top-0 z-30">
        ...
        <div class="px-6 md:px-8 pb-8 flex-grow overflow-y-auto w-full mx-auto space-y-6 max-w-[1400px]">
            ...
            <!-- Filter & Search Bar -->
            <div
                class="flex flex-col md:flex-row justify-between items-center gap-4 pt-2 border-b border-gray-200 pb-4">
                <div class="flex flex-wrap gap-4 items-center w-full md:w-auto">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <select id="filter-room" onchange="filterAndRender()"
                            class="pl-3 pr-8 py-2 border border-gray-300 rounded-xl text-sm focus:outline-none focus:border-[#6196aa] text-gray-700 bg-white shadow-sm cursor-pointer">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    <div class="relative w-full md:w-64">
                        ...
                        <input type="text" id="search-input" onkeyup="filterAndRender()"
                            placeholder="Cari nama barang..."
                            class="pl-9 pr-4 py-2 w-full border border-gray-300 rounded-xl text-sm focus:outline-none focus:border-[#6196aa] text-gray-700 shadow-sm">
                    </div>
                </div>
            </div>
    ...
    <!-- Verify QR Modal -->
    <div id="verifyQrModal"
        class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm overflow-y-auto pt-10 pb-10">
            ...
            <div class="p-6 overflow-y-auto flex-grow">
                <form id="verifyQrForm" onsubmit="handleVerifyQr(event)">
                    ...
                    <div class="mb-6">
                        ...
                        <!-- Upload Area -->
                        <div class="mt-2 mb-4">
                            <label for="qr_image_upload"
                                class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors relative">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="mb-1 text-sm text-gray-500 font-semibold">Klik untuk upload gambar QR Code
                                    </p>
                                    <p class="text-xs text-gray-500">PNG, JPG, atau JPEG</p>
                                </div>
                                <input id="qr_image_upload" type="file" accept="image/*" class="hidden"
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">Atau masukkan kode
                                manual</span>
                            <div class="h-px bg-gray-200 flex-1"></div>
                        </div>

                        <input type="text" id="modal_qr_univ" required
                            placeholder="Masukkan teks kode QR secara manual..."
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-[#6196aa] focus:ring-[#6196aa] text-sm p-2.5 border">
                        <p class="text-xs text-gray-500 mt-2">Otorisasi universitas diperlukan sebelum dapat memberikan
                            label barang.</p>
                    </div>
                    <canvas id="qr_canvas" hidden></canvas>
                    <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                        <button type="button" onclick="closeVerifyModal()"
                            class="px-5 py-2.5 border border-gray-300 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors">Batal</button>
                        <button type="submit" id="btn_verify_qr"
                            class="px-5 py-2.5 bg-[#20394a] text-white rounded-xl text-sm font-semibold hover:bg-[#6196aa] shadow-lg transition-colors">
                            Verifikasi QR
                        </button>
                    </div>
                </form>
    ...
    <!-- Assign Label Modal -->
    <div id="assignLabelModal"
        class="fixed inset-0 z-[60] hidden items-center justify-center bg-black/50 backdrop-blur-sm overflow-y-auto pt-10 pb-10">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 overflow-hidden flex flex-col max-h-full">
            ...
            <div class="p-6 overflow-y-auto flex-grow">
                <form id="assignLabelForm">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="modal_nomor_label" required placeholder="Contoh: ELEK-001"
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-[#6196aa] focus:ring-[#6196aa] text-sm p-2.5 border">
                        <p class="text-xs text-gray-500 mt-2">Sistem akan secara otomatis men-generate QR Code
                            berdasarkan nomor label yang dimasukkan.</p>
                    </div>
                    <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                        <button type="button" onclick="closeAssignModal()"
                            class="px-5 py-2.5 border border-gray-300 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors">Batal</button>
                        <button type="button" onclick="handleAssignLabel(event)" id="btn_assign_label"
                            class="px-5 py-2.5 bg-[#20394a] text-white rounded-xl text-sm font-semibold hover:bg-[#6196aa] shadow-lg transition-colors">
                            Simpan Label
                        </button>
                    </div>
    ...
    <div id="successModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 overflow-hidden p-6 text-center">
            ...
            <button onclick="closeSuccessModal()"
                class="w-full px-5 py-2.5 bg-[#20394a] text-white rounded-xl text-sm font-semibold hover:bg-[#6196aa] shadow-lg transition-colors">Tutup</button>
        </div>
    </div>
    ...
    <div id="duplicateModal"
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 overflow-hidden p-6">
            <div class="flex items-start gap-4 mb-4">
                <div
                    class="w-12 h-12 bg-orange-100 text-orange-500 rounded-full flex-shrink-0 flex items-center justify-center">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Nomor label <strong id="dup-old-label"></strong> sudah dipakai oleh
                        barang lain. Sistem merekomendasikan menggunakan nomor label berikut:</p>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100 mt-4">
                <button type="button" onclick="closeDuplicateModal()"
                    class="px-4 py-2 border border-gray-300 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors">Ketik
                    Ulang Manual</button>
                <button type="button" onclick="useSuggestionLabel()"
                    class="px-4 py-2 bg-[#20394a] text-white rounded-xl text-sm font-semibold hover:bg-[#6196aa] shadow-lg transition-colors">Gunakan
                    Saran Ini</button>
            </div>
        </div>
    </div>
    ...
    <div id="groupItemsModal"
        class="fixed inset-0 z-[80] hidden items-center justify-center bg-black/50 backdrop-blur-sm overflow-y-auto pt-10 pb-10">
        <div
            class="bg-white rounded-2xl shadow-xl w-full max-w-3xl mx-4 overflow-hidden flex flex-col max-h-full border border-gray-100">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-[#f9f5ed]/50 shrink-0">
                <div>
                    <h3 id="modal-group-title" class="text-xl font-bold text-[#20394a]">Nama Barang</h3>
                    <p id="modal-group-subtitle" class="text-sm font-semibold text-gray-500 mt-1">Total: 0 Unit | Rusak:
                        0</p>
                </div>
                <button onclick="closeGroupModal()"
                    class="text-gray-400 hover:text-red-500 transition-colors bg-white p-2 rounded-full shadow-sm border border-gray-200">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M6 18L18 6M6 6l12 12" />
                    </svg>
            ...
            <div class="p-0 overflow-y-auto flex-grow bg-gray-50 relative max-h-[60vh]">
                <table class="w-full text-left text-sm border-collapse">
                    <thead class="sticky top-0 z-10">
                        <tr
                            class="bg-white text-gray-500 uppercase tracking-wider text-xs font-bold border-b border-gray-200 shadow-sm">
            ...
            <div class="p-4 border-t border-gray-100 bg-white text-right shrink-0">
                <button onclick="closeGroupModal()"
                    class="px-5 py-2.5 bg-[#20394a] text-white rounded-xl text-sm font-semibold hover:bg-[#6196aa] shadow-lg transition-colors">Tutup</button>
            </div>
        </div>
    </div>
