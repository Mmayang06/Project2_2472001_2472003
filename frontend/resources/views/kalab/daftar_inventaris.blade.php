...
<body
    ...
    <aside
        ...
        <div class="p-6 border-b border-[#6196aa]/20 flex items-center justify-between">
            <a href="/" class="flex items-center gap-3 group">
                ...
                <div>
                    ...
                    <span
                        class="text-[10px] text-emerald-400 font-semibold tracking-wide block mt-1">{{ session('user')['username'] ?? 'Kepala Lab' }}</span>
                </div>
            </a>
        ...
        <nav class="flex-grow p-4 space-y-2 mt-4">
            ...
            <a href="/kalab/daftar-inventaris"
        ...
        <div class="p-4 border-t border-[#6196aa]/20">
            ...
            <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                class="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg border border-[#c9ccc3]/20 hover:bg-[#c9ccc3]/10 text-xs font-semibold text-[#c9ccc3] hover:text-[#f9f5ed] transition-all duration-200">
